...
def get_vertices(raw_nodes_data):
    """
    Function to get vertex name
    :param raw_nodes_data: raw data of nodes sent by JS
    :type raw_nodes_data: JSON object
...
def get_distance_matrix(raw_edge_data, node_count):
    """
    Function to get distance between vertex and create distance matrix
    :param raw_edge_data: raw data of edges sent by JS JS
    :type raw_edge_data: JSON object
    :param node_count: number of vertex
    :type node_count: int
    :return: matrix of distance between vertices
    :rtype: list of list
    """
...
def get_heuristic_distance_matrix(raw_nodes_data):
    """
    Function to get distance between vertex and create heuristic matrix (heuristic distance)
    :param raw_nodes_data: raw data of nodes sent by JS
    :type raw_nodes_data: JSON object
    :return: matrix of spherical distance between vertices (heuristic distance)
    :rtype: list of list
    """
...
def get_start_end(raw_data):
    """
    Get start and end point from raw data
    :param raw_data: raw data of nodes sent by JS
    :type raw_data: JSON
    :return: start node name, end node name
    :rtype: string, string
    """
    start = raw_data['From']
    end = raw_data['To']
